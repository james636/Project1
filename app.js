...
app.use(bodyParser.urlencoded({extended: false})); //function registers middleware function, package calls next so reqest reachers middleware. Won't parse files, need different parser
